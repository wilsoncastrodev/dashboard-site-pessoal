...
const sortCategoriesSkill = (payload: CategorySkillRequestType): Promise<AxiosResponse<CategorySkillResponseType>> => {
    return api.post<CategorySkillResponseType>(`category-skills/sort-categories-skill`, payload);
}
